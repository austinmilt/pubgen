/**
 * Rewritten from https://github.com/Meakk/circle-fit
 */
...
class Result {
    constructor(points) {
        ...
        this.radius = 0;
        this.residue = 0;
        this.computationTime = performance.now();
    }
}

export default class Calculator {

    linearSolve2x2 = (matrix, vector) => {
    ...
    compute = () => {
        ...
        let sol = this.linearSolve2x2([Sxx, Sxy, Sxy, Syy], [v1, v2]);
